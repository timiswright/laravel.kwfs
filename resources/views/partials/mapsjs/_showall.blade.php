<script>
// this is to show all so need to pass customers into here in a json array.
var map;
var markers = [];
...
customers.forEach(function(customer){
  ...
  var infowindow = new google.maps.InfoWindow({
    content: customer.company+'<br>'+customer.fname+' '+customer.lname+'<br><a href="../customers/'+customer.id+'">'+customer.postcode+'</a>'
  });
